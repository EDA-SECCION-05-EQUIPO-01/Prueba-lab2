...
def newCatalog():
    ...
    catalog['moviesIdsDetails'] =  mp.newMap(10000,
                                   maptype='PROBING',
                                   loadfactor=0.4,
                                   comparefunction=compareMapMoviesIds)
    catalog['moviesIdsCasting'] = mp.newMap(200,
                                  maptype='PROBING',
                                  loadfactor=0.4,
                                  comparefunction=compareMapMoviesIds)
    ...
    catalog['votesAverage'] =   mp.newMap(1000,
                                maptype='CHAINING',
                                loadfactor=0.7,
    ...
    catalog['productionCompanies'] = mp.newMap(1000,
                                     maptype='CHAINING',
                                     loadfactor=0.7,
    ...
    catalog['votesCount'] =       mp.newMap(500,
                                 maptype='CHAINING',
                                 loadfactor=0.7,
                                 comparefunction=compareCountry)
    return catalog
...
def addMovieCasting(catalog, movie):
    ...
    mp.put(catalog['directors'], movie['director_name'], movie)
